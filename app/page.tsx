      ...
      <div className="flex flex-col items-center justify-center min-h-screen px-6 text-center">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Link href="/creators">
              <button className="bg-rose-600 hover:bg-rose-500 transition-all px-16 py-6 rounded-3xl text-xl font-semibold w-full sm:w-auto">
                Explorer les créateurs
              </button>
            </Link>
            
            <Link href="/sell">
              <button className="border-2 border-white/70 hover:border-white transition-all px-16 py-6 rounded-3xl text-xl font-semibold w-full sm:w-auto">
                {t('sell')}
              </button>
            </Link>
          </div>
