...
// V4 - Page profil publique - affiche uniquement les images validées
...
export default function CreatorProfile() {
  ...
  // Simulation (à remplacer plus tard par une vraie requête Supabase)
  const creator = {
    id: parseInt(id),
    username: id === "3" ? "Sienna Rose" : id === "4" ? "Nova Lune" : "Lila Noir",
    avatar: "https://picsum.photos/id/1011/280/280",           // image validée
    banner: "https://picsum.photos/id/1005/1200/400",         // image validée
    verified: true,
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white">
      {/* Bannière publique (seulement l'image validée) */}
      ...
      <div className="max-w-5xl mx-auto px-6 -mt-12 relative z-10">
        ...
        <div className="mt-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {/* Tu peux ajouter tes articles ici plus tard */}
          </div>
        </div>
      </div>
