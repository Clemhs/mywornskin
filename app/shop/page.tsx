...
export default function ShopPage() {
  ...
  const fetchProducts = async (reset = false) => {
    ...
    let query = supabase
      ...
      `, { count: 'exact' })
      .eq('status', 'approved')
      .order(sortOption === 'price-low' || sortOption === 'price-high' ? 'price' : 'created_at', 
  ...
  useEffect(() => {
    fetchProducts(true);
  }, [supabase, sortOption, activeFilter, selectedSize, selectedShoeSize, selectedCountry, selectedCity]);
  ...
  // Extraction des valeurs uniques pour les dropdowns (uniquement ce qui existe)
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pb-20">
        ...
        {loading ? (
          ...
          <>
            ...
            {loadingMore && <p className="text-center text-zinc-400 mt-8">Chargement de plus de pièces...</p>}
          </>
        )}
      </div>
    </main>
