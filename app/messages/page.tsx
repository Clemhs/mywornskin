...
export default function Messages() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 flex items-center justify-center p-2 md:p-4">
      <div className="w-full max-w-5xl h-[85vh] bg-zinc-900 rounded-3xl overflow-hidden border border-zinc-700 shadow-2xl flex flex-col md:flex-row">

        {/* Sidebar Conversations - visible seulement sur PC */}
        <div className="hidden md:flex w-80 border-r border-zinc-800 flex-col bg-zinc-950">
          <div className="p-6 border-b border-zinc-800 bg-zinc-900">
            <h1 className="text-2xl font-bold">Messages</h1>
          </div>
          <div className="flex-1 overflow-y-auto p-3">
            <div className="p-4 bg-zinc-800 rounded-2xl mb-2 cursor-pointer">
