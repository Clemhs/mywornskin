    ...
    <div className="min-h-screen bg-zinc-950 pt-20 flex flex-col h-screen overflow-hidden">
      ...
      <div className="border-b border-zinc-800 p-4 bg-zinc-900 flex items-center gap-3">
        <button 
          ...
          className="md:hidden text-2xl pr-3"
        >
          ☰
        </button>
      ...
      <div className="flex flex-1 overflow-hidden relative">
        {/* Liste des conversations - visible sur PC, overlay sur mobile */}
            ...
            {conversations.map((conv) => (
              <div
                ...
                onClick={() => {
                  ...
                  setShowConversations(false); // Ferme le menu sur mobile
                }}
          ...
          <div className="p-4 bg-zinc-900 border-t border-zinc-800">
            ...
            <div className="flex items-center gap-3">
              ...
              <input
                ...
                className="flex-1 bg-zinc-800 border border-zinc-700 focus:border-rose-500 rounded-3xl px-5 py-4 text-base"
              />
