        ...
        <div className="bg-zinc-900 rounded-3xl p-10">
          ...
          {step === 1 && (
            <div>
              ...
              <button 
                ...
                className="w-full py-7 bg-rose-500 hover:bg-rose-600 disabled:bg-zinc-700 rounded-3xl text-xl mt-12 transition-all"
              >
                Continuer
              </button>
            </div>
          ...
          {step === 2 && (
            <div className="text-center py-12">
              ...
              <Link href="/creators" className="inline-block px-16 py-7 bg-rose-500 hover:bg-rose-600 rounded-3xl text-xl">
