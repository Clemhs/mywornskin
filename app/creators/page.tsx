...
// === V9 - RECREATION COMPLETE DU FICHIER - 23 AVRIL 2025 ===
// Badges pièces métalliques + cadres musée larges + vraies photos créatrices
          ...
          {filteredCreators.map((creator) => (
            <Link key={creator.id} href={`/creators/${creator.id}`} className="card group overflow-hidden">
              <div className="relative">
                ...
                {creator.frame && (
                  <div className={`absolute inset-0 border-[14px] rounded-3xl pointer-events-none
                ...
                <div className="absolute -bottom-8 left-6">
                  <div className="relative">
                    ...
                    />
                    {creator.badge && (
                      <div className="absolute -top-1 -right-1 bg-gradient-to-br from-rose-200 via-rose-400 to-amber-400 text-zinc-950 text-3xl font-bold w-11 h-11 rounded-2xl flex items-center justify-center shadow-2xl ring-4 ring-zinc-900">
                        {creator.badge}
                      </div>
                    )}
                  </div>
