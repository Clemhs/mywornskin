    ...
    <div className="min-h-screen bg-zinc-950 text-white p-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="relative h-80 rounded-3xl overflow-hidden mb-12 border border-zinc-800">
          ...
          />
          <div className="absolute -bottom-8 left-8 w-32 h-32 rounded-3xl border-4 border-zinc-950 overflow-hidden">
            <img
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          <div>
            <label className="block text-zinc-400 mb-3">Photo de profil</label>
            <input
              type="file"
              accept="image/*"
          ...
          <div>
            <label className="block text-zinc-400 mb-3">Image de couverture</label>
            <input
              type="file"
              accept="image/*"
