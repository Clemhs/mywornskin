  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white">
      ...
      <div className="pt-20 max-w-6xl mx-auto px-6">
        {/* Bannière */}
        <div className="h-80 bg-gradient-to-r from-rose-950 via-zinc-900 to-zinc-800 rounded-3xl relative overflow-hidden mb-12">
          {creator.banner_url && (
            <img 
        ...
        <div className="flex flex-col md:flex-row gap-10 -mt-20">
          ...
          <div className="flex-1 pt-8">
            ...
            {/* À compléter plus tard : badges, cadres, produits, avis... */}
            <div className="mt-16 text-zinc-500 text-sm">
              Badges, cadres, produits et avis seront ajoutés ici prochainement.
            </div>
          </div>
        </div>
      </div>
