            ...
            <div>
              ...
              <div className="bg-zinc-950 border border-zinc-800 rounded-3xl p-6 space-y-5">
                <div>
                  ...
                  <textarea value={bio} onChange={handleBioChange} rows={3} className="w-full bg-zinc-900 border border-zinc-700 rounded-2xl px-4 py-3 text-sm focus:outline-none focus:border-pink-500" />
                </div>
