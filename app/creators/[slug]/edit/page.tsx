          ...
          <div className="lg:col-span-5 space-y-8">
            <div>
              ...
              <div className="relative rounded-3xl overflow-hidden bg-zinc-900 border border-zinc-800 aspect-video">
                ...
                {isBannerPending && <div className="absolute top-4 right-4 bg-amber-500 text-black text-sm px-4 py-1 rounded-full flex items-center gap-2"><Clock size={16} /> En attente</div>}
