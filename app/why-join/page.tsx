...
export default function WhyJoinPage() {
  return (
    <div className="min-h-screen bg-zinc-950 text-white pt-20 py-16">
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="bg-zinc-900 rounded-3xl p-10">
            ...
            <Link href="/sell" className="mt-12 block text-center py-7 bg-rose-500 hover:bg-rose-600 rounded-3xl text-xl font-medium transition-all">
          ...
          <div className="bg-zinc-900 rounded-3xl p-10">
            ...
            <Link href="/creators" className="mt-12 block text-center py-7 bg-rose-500 hover:bg-rose-600 rounded-3xl text-xl font-medium transition-all">
